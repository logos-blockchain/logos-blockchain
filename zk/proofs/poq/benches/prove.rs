...
fn common_data_leader() -> PoQCommonInputsData {
    PoQCommonInputsData {
        selector: true,
        ..common_data_core()
    }
...
fn make_core_node_inputs() -> PoQWitnessInputs {
    ...
    PoQWitnessInputs::from_core_node_data(chain_data, common_data_core(), blend_data).unwrap()
}
...
fn make_leader_inputs() -> PoQWitnessInputs {
    ...
    PoQWitnessInputs::from_leader_data(chain_data, common_data_leader(), wallet_data).unwrap()
}

#[divan::bench]
fn bench_prove_core_node(bencher: divan::Bencher) {
    let inputs = make_core_node_inputs();
    bencher
