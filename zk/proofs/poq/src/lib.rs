...
mod tests {
    ...
    fn test_pow_full_flow() {
        let chain_data = PoQChainInputsData {
            core_root: BigUint::from_str(
                "17221527552435885266381262988260904945767902157699339824536328890908744829004",
            )
            .unwrap()
            .into(),
            pol_ledger_aged: BigUint::from_str(
                "15524203674561292134108415479004597997158273575770759806968210936102441082561",
            )
            .unwrap()
            .into(),
            pol_epoch_nonce: BigUint::from_str(
                "9044881160076582754939149961589913743685188188594985299351503064212059195449",
            )
            .unwrap()
            .into(),
            lottery_0: BigUint::from_str(
        ...
        let common_data = PoQCommonInputsData {
            ...
            index: KeyIndex::new::<19>(),
            pow_difficulty: BigUint::from_str(
                "11767310438037502057348804636667730067145920466135580383473019029395854041585",
            )
            .unwrap()
            .into(),
        };
        let pow_data = PoQPowInputsData {
            pow_nonce: BigUint::from_str(
                "3208667997606854837691155513582782452110664647780085150997178953548554066249",
            )
            .unwrap()
            .into(),
        };
