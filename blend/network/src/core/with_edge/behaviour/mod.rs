...
use either::Either;
use lb_blend_message::encap::validated::SessionBoundEncapsulatedMessageWithVerifiedSignature;
...
impl Behaviour {
    ...
    fn handle_received_serialized_encapsulated_message(&mut self, serialized_message: &[u8]) {
        ...
        self.events.push_back(ToSwarm::GenerateEvent(Event::Message(
            SessionBoundEncapsulatedMessageWithVerifiedSignature::new(
                validated_message,
...
impl NetworkBehaviour for Behaviour {
    ...
    fn handle_established_inbound_connection(
        ...
        } else if self.current_session_info.0.contains(&peer) {
