...
pub enum PayloadType {
    /// Meaningless content, carried only to create the noise a data message
    /// hides in.
    Cover = 0x00,
    /// A block proposal, generated by a consensus leader.
    BlockProposal = 0x01,
    /// A Mantle transaction, which any participant may generate.
    Transaction = 0x02,
}
