...
/// The well-known bytes of a `PublicHeader` (the reconstructed signing key of
/// all `0x00`, a proof of quota of all `0x01`, and a signature of all `0x02`).
/// Shared by the `PublicHeader` fixture and the two verified wrappers, which
/// encode to the same bytes.
const PUBLIC_HEADER_HEX: &str = "";
