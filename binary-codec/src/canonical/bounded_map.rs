...
mod tests {
    ...
    fn decode_reads_entries_in_canonical_order() {
        let (rest, decoded) =
            Map::decode(&[2, 0x00, 0x01, 0xBB, 0x01, 0x00, 0xAA], &((), ())).unwrap();
    ...
    fn fixtures_pair_distinct_keys_with_cycled_values() {
        ...
        assert_codec_fixtures_with::<BoundedMap<u8, u8, 0, 4>, _>(|| ((), ()));
    }

    #[test]
    fn fixtures_respect_small_bounds() {
        assert_codec_fixtures_with::<BoundedMap<u8, u16, 0, 0>, _>(|| ((), ()));
        assert_codec_fixtures_with::<BoundedMap<u8, u16, 1, 1>, _>(|| ((), ()));
        assert_codec_fixtures_with::<BoundedMap<u16, bool, 2, 2>, _>(|| ((), ()));
    }
