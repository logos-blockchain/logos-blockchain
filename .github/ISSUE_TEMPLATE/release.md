...
- [ ] Checkout `devnet` branch again and change the `compose.static.yml` symlink to now point to `compose.run.yml`
...
- [ ] Go back to the [GitHub Release][github-release-section] section and finalize the release candidate
