...
For the former, please reach out to the Logos Blockchain team to get a copy of it and a list of bootnode addresses for the network you intend to join.
...
For example: `logos-blockchain-node-macos-aarch64-0.0.1 --deployment deployment.yaml config.yaml`. See the repo's `README.md` for more info.
