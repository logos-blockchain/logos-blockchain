...
You can compare your consensus state with any nodes of the Logos Blockchain fleet reachable at [https://devnet.blockchain.logos.co/web/node-data](https://devnet.blockchain.logos.co/web/node-data/).
