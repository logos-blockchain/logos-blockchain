...
pub type BlendCoreRecoveryBackend<RuntimeServiceId> = StorageRecoveryBackend<
    lb_blend_service::core::CoreServiceState<
        ...
        <lb_blend_service::core::network::traced_libp2p::Libp2pAdapter<RuntimeServiceId> as lb_blend_service::core::network::NetworkAdapter<RuntimeServiceId>>::BroadcastSettings,
    >,
