...
fn is_within_reward_window(block_slot: Slot, current_slot: Slot, slot_window: u64) -> bool {
    u64::from(block_slot)
...
fn prune_expired_tickets(state: &mut PoWServiceState, current_slot: Slot, slot_window: u64) {
