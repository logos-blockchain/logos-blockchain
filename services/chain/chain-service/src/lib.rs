...
impl Cryptarchia {
    ...
    pub fn from_lib(
        ...
        Self {
            ...
            ledger: <logos_blockchain_ledger::Ledger<_>>::new(lib_id, lib_ledger_state, ledger_config),
            genesis_id,
        }
    }
        ...
        Tx: AuthenticatedMantleTx,
    {
        ...
        let ledger = self
            ...
            .map_err(|err| match err {
                logos_blockchain_ledger::LedgerError::ParentNotFound(parent) => Error::ParentMissing {
                    parent,
                    info: self.info(),
                },
