...
codec_fixtures!(
    ...
    } => ""
);
codec_fixtures!(
    ActivityProof,
    Self {
        ...
        proof_of_selection:
            VerifiedProofOfSelection::from_bytes_unchecked([1u8; _])
                .into(),
    } => ""
);
codec_fixtures!(
    ActivityMetadata,
