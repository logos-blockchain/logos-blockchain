...
mod test {
    ...
    use super::*;
    use crate::mantle::{TxHash, gas::test_utils::FixedThresholds, ops::channel::ChannelId};
    ...
    fn verify_rejects_an_input_missing_from_the_ledger() {
        ...
        assert_eq!(
            signed_operation
                ...
                .unwrap_err(),
            TransferError::Inputs(ledger::InputsError::InexistingNote(input_utxo.id()))
        );
    }
    ...
    fn verify_rejects_an_input_owned_by_a_channel() {
        ...
        assert_eq!(
            signed_operation
                ...
                .unwrap_err(),
            TransferError::Inputs(ledger::InputsError::ChannelNote(input_utxo.id()))
        );
    }
